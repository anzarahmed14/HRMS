...
{
    private readonly IReadRepository<HRMS.Modules.Employee.Domain.Entities.Employee, Guid> _employeeRepository;
    ...
    private readonly IReadRepository<Role, Guid> _roleRepository;
     ...
     public IdentityBusinessRules(
        IReadRepository<HRMS.Modules.Employee.Domain.Entities.Employee, Guid> employeeRepository,
        IReadRepository<HRMS.Modules.Identity.Domain.Entities.User, Guid> userRepository,IReadRepository<Role, Guid> roleRepository)
    {
    ...
    public async Task<HRMS.Modules.Identity.Domain.Entities.User> EnsureUserCanLoginAsync( string userName, CancellationToken cancellationToken = default)
    {
