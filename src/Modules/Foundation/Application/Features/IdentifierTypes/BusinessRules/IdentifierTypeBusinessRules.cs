...
namespace HRMS.Modules.Foundation.Application.Features.IdentifierTypes.BusinessRules;

public class IdentifierTypeBusinessRules
{
    private readonly IReadRepository<IdentifierType, Guid> _repository;

    public IdentifierTypeBusinessRules(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (exists)
        {
            throw new ConflictException(
                $"Identifier type code '{code}' already exists.");
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new ConflictException(
                $"Identifier type name '{name}' already exists.");
        }
    }
