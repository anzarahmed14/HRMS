...
public sealed class DeleteAttendanceRegularizationCommandHandler
    : IRequestHandler<DeleteAttendanceRegularizationCommand>
{
    ...
    public DeleteAttendanceRegularizationCommandHandler(
    ...
    public async Task Handle(
        DeleteAttendanceRegularizationCommand request,
        CancellationToken cancellationToken)
    {
            ...
            PendingStatusId)
        {
            throw new ConflictException(
                "Only pending attendance regularizations can be deleted.");
        }
